...
const prisma_service_1 = __webpack_require__(13);
const error_functions_1 = __webpack_require__(16);
...
const common_1 = __webpack_require__(4);
const dist_1 = __webpack_require__(14);
...
const common_1 = __webpack_require__(4);
const config_1 = __webpack_require__(18);
const dist_1 = __webpack_require__(19);
const prisma_service_1 = __webpack_require__(13);
...
const common_decorator_1 = __webpack_require__(25);
class AuthDto {
...
class ControlsArray {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => Object }, controls: { required: true, type: () => [Object] } };
    }
}
__decorate([
...
class UserCreatedDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String }, moduleAccess: { required: true, type: () => [(__webpack_require__(26).ControlsArray)] }, role: { required: true, type: () => Object }, companyName: { required: true, type: () => String }, verifyUser: { required: true, type: () => Boolean } };
    }
}
__decorate([
    (0, swagger_1.ApiProperty)(),
