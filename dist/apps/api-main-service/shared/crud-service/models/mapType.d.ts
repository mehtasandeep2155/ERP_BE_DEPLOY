...
export declare class UserTypeMap implements CrudTypeMap {
...
export declare class ColorTypeMap implements CrudTypeMap {
...
export declare class UomTypeMap implements CrudTypeMap {
...
export declare class ProductCategoryTypeMap implements CrudTypeMap {
...
export declare class ProductVariantTypeMap implements CrudTypeMap {
...
export declare class ProductDimensionTypeMap implements CrudTypeMap {
...
export declare class RateTypeMap implements CrudTypeMap {
...
export declare class ProductTypeMap implements CrudTypeMap {
...
export declare class CompanyTypeMap implements CrudTypeMap {
...
export declare class SubCompanyTypeMap implements CrudTypeMap {
...
export declare class PurchaseOrderTypeMap implements CrudTypeMap {
...
export declare class InventoryViewTypeMap implements CrudTypeMap {
...
export declare class InventoryTypeMap implements CrudTypeMap {
...
export declare class StockTypeMap implements CrudTypeMap {
...
export declare class StockActionsTypeMap implements CrudTypeMap {
...
export declare class CustomerTypeMap implements CrudTypeMap {
